import type {
  ...
  import { AddInstitutePanelView } from "@app/ui/main/projects/add-institute/add-institute-panel.view.tsx";
  import { textAreOnlySpaces } from "@utils/text-are-only-spaces";
  import { getRandomProjectImage } from "@utils/random-project-image";
  import { formatTags, formatProperties } from "@utils/meta";
  
  export const meta: V2_MetaFunction = () => {
    const title = "Task Management - Add Institute";
...
//   };
  ...
  export default function IssuePanelRoute() {
    ...
    return <AddInstitutePanelView users={users} />;
    return <h1>hello</h1>
  }
