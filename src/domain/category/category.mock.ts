...
const issuesMock1 = [todoIssuesMock1, inProgressIssuesMock1, doneIssuesMock1, readyIssuesMock1];

const ids2 = [
  "bbb348d5-ef02-447c-94f5-5fbf1ceeac07",
  "14055a19-1a79-4b16-90fb-811652e33128",
  "aa102bcb-335c-4d82-8392-058f6172ebe8",
  "c1278yd3-29b3-422c-8219-54bbh6b26ff4",
];
const issuesMock2 = [todoIssuesMock2, inProgressIssuesMock2, doneIssuesMock2, readyIssuesMock2];
